...
var evmCode = "";
...
var callback = function(e, contract){
	if(e == null) {
		...
		if(typeof contract.address !== 'undefined'){
            ...
            console.log("Value:", parseInt(oneValueInst.getValue()));
		}
    } else {
		console.log(e);
	}
